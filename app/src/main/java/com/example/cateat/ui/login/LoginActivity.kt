...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginViewModel.loginResult.observe(this@LoginActivity, Observer {
            ...
            if (loginResult.success != null) {
                ...
                saveLocalUser(username.text.toString(), password.text.toString())
    ...
    private fun login(username: String, password: String) {
        val loginUrl = getString(R.string.cat_service_login_url)
        runBlocking {
            launch {
                loginViewModel.login(loginUrl, username, password)
            }
        }
    }
    ...
    private fun saveLocalUser(username: String, password: String) {
        val user = UserLoginDto(username, password)
        localDbConnection.addUserInfo(user)
    }
}
