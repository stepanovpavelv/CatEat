...
class LoginRepository(val dataSource: LoginDataSource) {
    ...
    constructor() : this(LoginDataSource())
    ...
    suspend fun login(url: String, username: String, password: String): Result<LoggedInUser> {
        // handle login
        val result = dataSource.login(url, username, password)
